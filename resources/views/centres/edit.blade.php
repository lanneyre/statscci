...
@section('main')
    <h1>Gestion des centres - Edit</h1>
    <form method="POST" action="{{ route('Centre.update', $centre) }}">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col">
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="text" name="lieu" class="form-control" id="lieu" value="{{ $centre->lieu }}"
