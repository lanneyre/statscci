...
@section('main')
    <h1>Gestion des formations - Ajout</h1>
            ...
            <div class="col">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="numConvention" id="numConvention"
                        placeholder="Numéro de convention" value="{{ old('numConvention') }}">
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label for="dd" class="form-label">Date de début</label>
                    <input type="date" name="dd" class="form-control" id="dd" value="{{ old('dd') }}">
                </div>
                <div class="mb-3">
                    <label for="df" class="form-label">Date de fin</label>
                    <input type="date" name="df" class="form-control" id="df" value="{{ old('df') }}">
                </div>
                <div class="mb-3">
