    ...
    <div class="sidebar">
        <ul class="list-group flex-column d-inline-block first-menu">
            {{-- <li class="list-group-item pl-3 py-2">
                <a href="#"><i class="fa fa-graduation-cap" aria-hidden="true"><span
                            class="ml-2 align-middle">Formations</span></i></a>
            </li> <!-- /.list-group-item -->

            <li class="list-group-item pl-3 py-2">
                <a href="#"><i class="fa fa-university" aria-hidden="true"><span
                            class="ml-2 align-middle">Centres</span></i></a>
            </li> <!-- /.list-group-item -->

            <li class="list-group-item pl-3 py-2">
                <a href="#">
                    <i class="fa fa-check-square-o" aria-hidden="true"><span
                            class="ml-2 align-middle">Critères</span></i>
                </a>
            </li> <!-- /.list-group-item --> --}}
            ...
            <li class="list-group-item pl-3 py-2">
                <a href="{{ route('import') }}"><i class="fa fa-upload" aria-hidden="true"><span
                            class="ml-2 align-middle">Import</span></i></a>
            </li>
